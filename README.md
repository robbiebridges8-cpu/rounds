...
A pub check-in app for London. Log the pubs you go to, turn boroughs gold, see where your mates have been.
...
| `(tabs)/you` | The poster: the fill-in map on the white ground, gold where you have been, your borough count, stats strip, Overview / Pubs / Diary tabs, share and invite |
