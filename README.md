...
**Tagging.** A tag is a question. The tagged mate gets "Were you there?" as a push, in Activity, and on the post, with Yes and No. Yes counts the pub for them through a hidden check-in that points at the original, and the original post reaches their friends too, unless they had already logged that night themselves. No deletes the tag. People not on the app get a name on the post and a text with your invite link.
